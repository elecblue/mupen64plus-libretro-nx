...
# 
# Nintendo Switch-specific build flags and includes
# 
...
# 
# Jetson Xavier NX-specific build flags
#
...
# 
# ODROID [64bit]-specific build flags
#
...
#   
# Windows-specific build flags/Fallback for unhandled platforms
# 
